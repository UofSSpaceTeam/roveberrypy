...
static const MOC_SPEC moc_spec[] = {
    {0, INVALID_U, EXTERNAL_FB, INVALID_U, INVALID_U, INVALID_U},
    {1, INVALID_U, EXTERNAL_FB, INVALID_U, INVALID_U, INVALID_U},
    {2, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0},
    {3, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0},
    {4, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0},
    {5, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0},
    {6, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0},
    {7, INVALID_U, INTERNAL_FB, INVALID_U, 15, 0}
};
